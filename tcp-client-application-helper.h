...
#ifndef TCP_CLIENT_APPLICATION_HELPER_H
#define TCP_CLIENT_APPLICATION_HELPER_H
...
/**
 * \ingroup bulksend
 * \brief A helper to make it easier to instantiate an ns3::TcpClientApplication
 * on a set of nodes.
 */
